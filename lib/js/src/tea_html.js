...
function onClick$p(keyOpt, msg) {
  var key = keyOpt !== undefined ? keyOpt : "";
  return Vdom.onCB("click", key, (function (_ev) {
...
function onDoubleClick$p(keyOpt, msg) {
  var key = keyOpt !== undefined ? keyOpt : "";
  return Vdom.onCB("dblclick", key, (function (_ev) {
                return Caml_option.some(msg);
              }));
}
...
function onBlur$p(keyOpt, msg) {
  var key = keyOpt !== undefined ? keyOpt : "";
  return Vdom.onCB("blur", key, (function (_ev) {
                return Caml_option.some(msg);
              }));
}
...
var Events = {
  ...
  onDoubleClick$p: onDoubleClick$p,
