...
var Rescript_json_combinators_extended = require("./rescript_json_combinators_extended.js");
...
function onCB(key, eventName, cb) {
  return Vdom.onCB(eventName, key, cb);
}
...
function onWithOptions(key, eventName, options, decoder) {
  return Vdom.onCB(eventName, key, (function ($$event) {
                ...
                var result = Json$JsonCombinators.decode($$event, decoder);
                if (result.TAG === /* Ok */0) {
...
var targetValue = Rescript_json_combinators_extended.at({
      hd: "target",
      tl: {
        hd: "value",
        tl: /* [] */0
...
var targetChecked = Rescript_json_combinators_extended.at({
      hd: "target",
      tl: {
        hd: "checked",
        tl: /* [] */0
...
var keyCode = Json_Decode$JsonCombinators.field("keyCode", Json_Decode$JsonCombinators.$$int);
...
function onSubmit(msg) {
  return preventDefaultOn(undefined, "submit", Json_Decode$JsonCombinators.custom(function (_value) {
                  return msg;
                }));
}
