...
function debug(string_of_msg, update, view, subscriptions, shutdown) {
  ...
  var viewHistory = function (model, selected_index) {
                ...
                tl: /* [] */0
                      ...
                      return Tea_html.li(undefined, undefined, {
                                  ...
                                  hd: Tea_html.span(undefined, undefined, {
                                        ...
                                        tl: selected ? ({
                                              hd: Tea_html.Events.onClick(/* ToggleDetails */1),
                                              tl: {
                                        ...
                                        hd: selected && model.show_details ? viewDetails(param[1]) : Tea_html.noNode,
                                        tl: /* [] */0
                                      }),
                                  tl: {
                                    hd: Tea_html.span(undefined, undefined, {
  ...
  var view$p = function (model) {
    ...
    return Tea_html.div(undefined, undefined, /* [] */0, {
                hd: Vdom.map(clientMsg, Curry._1(view, match[1])),
                tl: {
  ...
  var subscriptions$p = function (model) {
    return Tea_sub.map(clientMsg, Curry._1(subscriptions, List.hd(model.history)[1]));
  };
  var shutdown$p = function (model) {
    return Tea_cmd.map(clientMsg, Curry._1(shutdown, List.hd(model.history)[1]));
  };
  return [
          initDebug,
          update$p,
...
function debugProgram(string_of_msg, param) {
  ...
  return {
          init: (function (flags) {
              return Curry._1(initDebug, Curry._1(init, flags));
            }),
          update: match[1],
          view: match[2],
...
function debugNavigationProgram(string_of_msg, param) {
  ...
  return {
          init: (function (flags, $$location) {
              return Curry._1(initDebug, Curry._2(init, flags, $$location));
            }),
          update: match[1],
          view: match[2],
          subscriptions: match[3],
...
function navigationProgram(location_to_msg, param, string_of_msg, pnode, flags) {
  ...
  var debugged = debugNavigationProgram(string_of_msg, {
        init: param.init,
        update: param.update,
        view: param.view,
        subscriptions: param.subscriptions,
...
exports.debugNavigationProgram = debugNavigationProgram;
