...
function track(toMessage, param) {
  ...
  var onprogress = (function (callbacks, ev) {
      var _e = Json_Decode$JsonCombinators.decode(ev, Json_Decode$JsonCombinators.field("lengthComputable", Json_Decode$JsonCombinators.bool));
      ...
      var decoder = Json_Decode$JsonCombinators.object(function (field) {
            return {
                    bytes: field.required("loaded", Json_Decode$JsonCombinators.$$int),
                    bytesExpected: field.required("total", Json_Decode$JsonCombinators.$$int)
                  };
          });
      var _e$1 = Json_Decode$JsonCombinators.decode(ev, decoder);
      if (_e$1.TAG === /* Ok */0) {
...
exports.stringOfError = stringOfError;
